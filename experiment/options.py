...
def algo_args_parser():
    ...
    running_environment.add_argument( '--device', type=str, default='cpu', choices=['cpu', 'gpu'],)
    ...
    specific_task.add_argument('--tao', default=1.0, type=float)
    specific_task.add_argument('--bids', default=(1.0, 3.0), type=tuple)
    specific_task.add_argument('--scores', default=(0, 1.0), type=tuple)
    specific_task.add_argument('--budget_mode', default='total', type=str)
    specific_task.add_argument('--auction_mode', default='cmab', type=str)
    specific_task.add_argument('--budgets', default=(600, 600), type=tuple)
    # 二阶段质量公平参数
    ...
    specific_task.add_argument('--e_mode', default='local', choices=['local', 'optimal'], type=str)
    ...
    # TMC_shapely 参数
    specific_task.add_argument('--iters', default=4000, type=int)
