...
def build_card(icon: str, title: str, description: str, button_text: str, color: str):
    with ui.card().classes("min-w-[300px]"):
        ...
        ui.button(button_text, on_click=lambda: ui.navigate.to(idx_dict[button_text])).props("dense icon-right='arrow_right' rounded padding='0.6em 1.2em'").classes("self-end")
