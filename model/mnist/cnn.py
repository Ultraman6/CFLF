...
class CNN_mnist(BaseModel):
    def __init__(self, mode='default'):
        ...
        self.conv1 = nn.Conv2d(1, 32, 5, padding=2)  # 保持原设置
        self.pool1 = nn.MaxPool2d(2, 2)
        self.act1 = nn.ReLU()
        self.conv2 = nn.Conv2d(32, 64, 5, padding=2)  # 将kernel size调整为5x5，padding调整为2以保持尺寸
        self.pool2 = nn.MaxPool2d(2, 2)
        self.act2 = nn.ReLU()
        self.flatten = nn.Flatten()
        self.out1 = nn.Linear(3136, 50)  # 由于padding调整保持输出尺寸不变，此处不需改动
